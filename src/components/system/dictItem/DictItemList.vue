<template>
    <div>
        <div class="cm-flex row" style="width: 100%;">
            <div class="cm-flex" style="width: 100px;" v-show="this.showButton(this.globalActionUrl.dictItem.save)">
                            ...
                            return h("div", [
                                h(
                                    "Button",
                                    {
                                        ...
                                        style: {
                                            marginRight: "5px",
                                            display: this.showButton(this.globalActionUrl.dictItem.detail) ? "inline" : "none"
                                        },
                                        on: {
                                            click: () => {
                                                this.showDetailForm(
                                ...
                                h(
                                    "Button",
                                    {
                                        ...
                                        style: {
                                            marginRight: "5px",
                                            display: this.showButton(this.globalActionUrl.dictItem.remove) ? "inline" : "none"
                                        },
                                        on: {
                                            click: () => {
                                                this.remove(
