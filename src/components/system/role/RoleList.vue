			...
			let buttons = [
				h(
					"a",
					{
						style: {
							marginRight: "10px",
							display: this.showButton(this.globalActionUrl.system.role.detailRole)
								? "inline"
								: "none"
						},
						on: {
				...
				h(
					"a",
					{
						style: {
							marginRight: "10px",
							display: this.showButton(this.globalActionUrl.system.role.editRole)
								? "inline"
								: "none"
						},
						on: {
				...
				buttons.push(
					h(
						"a",
						{
							style: {
								marginRight: "10px",
								display: this.showButton(this.globalActionUrl.system.role.removeRole)
									? "inline"
									: "none"
							},
							on: {
