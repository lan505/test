		...
		<div class="lx-form" :style="{ height: '400px' }">
			<Form ref="form" :model="form" :label-width="80" :rules="validate">
				<FormItem label="父级菜单" prop="treeParentId">
					<LxTreeSelect :value.sync="form.treeParentId" rowKey="menuId" :queryDataUrl="this.globalActionUrl.system.menu.queryMenuChildren" :treeFieldMap="{id: 'menuId', label: 'menuName'}"></LxTreeSelect>
				</FormItem>
